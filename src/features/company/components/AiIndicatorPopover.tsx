...
const QUESTIONS: { type: AiQuestionType; label: string }[] = [
  { type: "WHAT_IS", label: "O que é?" },
  { type: "HOW_INTERPRET", label: "Como interpretar?" },
  { type: "IS_HIGH", label: "Está alto?" },
  { type: "COMPARE_SECTOR", label: "Comparar com o setor" },
  { type: "HOW_CALCULATE", label: "Como calcular" },
]
...
export function AiIndicatorPopover({ companyId, indicatorKey, indicatorLabel }: AiIndicatorPopoverProps) {
