...
/// comes from indicator.getValue(dto) reading a nullable Prisma column (or
/// an exact arithmetic combination of two such columns), so there is no code
/// path that can fabricate a number. null renders as "—" plus an
...
/// what an indicator even means never requires an AI call.
